<form action="{{ route('settings.business.update') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-40">
        <h6 class="text-lg mb-20 fw-semibold">Business Identity</h6>
        <div class="row gy-3">
            <div class="col-md-6">
                <div class="mb-20">
    ...
    <div class="mb-40">
        <h6 class="text-lg mb-20 fw-semibold">Contact Information</h6>
        <div class="row gy-3">
            <div class="col-md-6">
                <div class="mb-20">
    ...
    <div class="mb-40">
        <h6 class="text-lg mb-20 fw-semibold">Regional Settings</h6>
        <div class="row gy-3">
            <div class="col-md-6">
                <div class="mb-20">
    ...
    <!-- Status Section -->
    <div class="mb-40">
        <h6 class="text-lg mb-20 fw-semibold">Business Status</h6>
        <div class="row">
            <div class="col-md-12">
