    ...
    <section class="auth d-flex flex-wrap min-vh-100">
        <div class="auth-left d-lg-flex d-none flex-column align-items-center justify-content-center p-5" style="flex: 0 0 40%; max-width: 40%;">
            <div class="text-center text-white">
                <div class="mb-5">
                    <iconify-icon icon="mdi:account-plus" style="font-size: 120px; opacity: 0.9;"></iconify-icon>
                </div>
                <h2 class="fw-bold mb-3">Join ArkSheets Today</h2>
                <p class="fs-5 opacity-90">Start managing your business efficiently</p>
                <div class="mt-5 d-flex flex-column gap-3 text-start" style="max-width: 400px;">
                    <div class="d-flex align-items-center gap-3">
                        <div class="bg-white bg-opacity-25 rounded-circle p-2" style="width: 48px; height: 48px;">
                            <iconify-icon icon="mdi:rocket-launch" style="font-size: 32px;"></iconify-icon>
                        </div>
                        <div>
                            <h6 class="mb-1 fw-semibold">Quick Setup</h6>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h6 class="mb-1 fw-semibold">Secure & Reliable</h6>
                            <small class="opacity-75">Your data is protected</small>
                        </div>
                    </div>
                    <div class="d-flex align-items-center gap-3">
                        <div class="bg-white bg-opacity-25 rounded-circle p-2" style="width: 48px; height: 48px;">
                            <iconify-icon icon="mdi:chart-box" style="font-size: 32px;"></iconify-icon>
                        </div>
                        <div>
                            <h6 class="mb-1 fw-semibold">Complete Solution</h6>
                            <small class="opacity-75">All tools in one place</small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="auth-right d-flex flex-column justify-content-center align-items-center p-4" style="flex: 1; min-height: 100vh;">
            <div class="max-w-464-px mx-auto w-100">
                <div class="mb-4">
                    ...
                    <h3 class="mb-2 brand-title">Create Account</h3>
                    <p class="mb-4 text-secondary-light">Fill in your details to get started</p>
                </div>
                ...
                <form action="{{ route('register') }}" method="POST" class="auth-card p-4">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="name" class="form-label fw-semibold text-primary-light">Full Name</label>
                            <div class="icon-field">
                                <span class="icon top-50 translate-middle-y" style="color: #ec3737;">
                                    <iconify-icon icon="mdi:account-outline" style="font-size: 20px;"></iconify-icon>
                                </span>
                                <input type="text" class="form-control h-56-px radius-8 @error('name') is-invalid @enderror" 
                                       id="name"
                                       name="name" 
                                       value="{{ old('name') }}" 
                    ...
                    <div class="mb-3 mt-3">
                        <label for="business_name" class="form-label fw-semibold text-primary-light">Business Name</label>
                        <div class="icon-field">
                            <span class="icon top-50 translate-middle-y" style="color: #ec3737;">
                                <iconify-icon icon="mdi:office-building-outline" style="font-size: 20px;"></iconify-icon>
                            </span>
                            <input type="text" class="form-control h-56-px radius-8 @error('business_name') is-invalid @enderror" 
                                   id="business_name"
                                   name="business_name" 
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            <label for="password-confirmation" class="form-label fw-semibold text-primary-light">Confirm Password</label>
                            <div class="position-relative">
                                <div class="icon-field">
                                    <span class="icon top-50 translate-middle-y" style="color: #ec3737;">
                                        <iconify-icon icon="mdi:lock-check-outline" style="font-size: 20px;"></iconify-icon>
                                    </span>
                                    <input type="password" class="form-control h-56-px radius-8" 
                    ...
                    <button type="submit" class="btn btn-brand text-sm px-12 py-12 w-100 radius-8 shadow-sm">
                        <iconify-icon icon="mdi:account-plus" class="me-2" style="font-size: 20px;"></iconify-icon>
                        Create Account
                    </button>

                    <div class="mt-4 text-center">
                        <span class="text-secondary-light">Already have an account?</span>
                        <a href="{{ route('login') }}" class="text-brand fw-semibold text-decoration-none ms-1">Sign In</a>
                    </div>
                </form>
            </div>
        </div>
