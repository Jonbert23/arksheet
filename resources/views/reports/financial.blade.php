            ...
            <div class="card-body p-20">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <a href="{{ route('reports.financial') }}" class="btn btn-outline-secondary d-flex align-items-center gap-2 radius-8 px-20 py-11">
                    ...
                    <div class="d-flex flex-wrap gap-2 align-items-center">
                        ...
                        <span class="badge bg-primary-100 text-primary-600 px-12 py-6 d-inline-flex align-items-center gap-2" style="padding-right: 8px !important;">
                            ...
                            <a href="{{ route('reports.financial') }}" class="text-primary-600 d-inline-flex align-items-center" style="text-decoration: none; margin-left: 4px;" title="Remove date filter">
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                            <div class="d-flex align-items-center gap-2">
                                <span class="mb-0 w-48-px h-48-px {{ $netProfit >= 0 ? 'bg-success-main' : 'bg-danger-main' }} flex-shrink-0 text-white d-flex justify-content-center align-items-center rounded-circle h6">
                                    <iconify-icon icon="{{ $netProfit >= 0 ? 'mdi:check-circle' : 'mdi:alert-circle' }}" class="icon"></iconify-icon>
                                </span>
                                <div>
